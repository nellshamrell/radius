...
// listAllResourcesByEnvironment takes in a context, an environment ID, list of
// resource types and clientOptions and returns a slice of GenericResources and an error if one occurs.
